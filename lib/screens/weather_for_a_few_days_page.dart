...
// /// Страница с погодой на несколько дней
// /// Дни отсортированны по увеличению температуры
// class WeatherForThreeDaysPage extends StatefulWidget {
//   final String cityName;
//   WeatherForThreeDaysPage({Key? key, required this.cityName}) : super(key: key);

//   @override
//   _WeatherForThreeDaysPageState createState() =>
//       _WeatherForThreeDaysPageState();
// }

// class _WeatherForThreeDaysPageState extends State<WeatherForThreeDaysPage> {
//   late Future<CityWeatherInfo> weatherInfo;

//   @override
//   void initState() {
//     super.initState();
//     weatherInfo = getCityWeatherInfo(widget.cityName);
//   }
...
//         centerTitle: true,
//       ),
//       body: FutureBuilder<CityWeatherInfo>(
//         future: weatherInfo,
...
//                 childrenDelegate: SliverChildBuilderDelegate(
//               (context, index) => listViewCard(snapshot.data!.list![index]),
//               childCount: snapshot.data!.cnt!.toInt(),
//             ));
//           } else if (snapshot.hasError) {
//             return const Text(
//                 'Ошибка получения данных '); // ${snapshot.error.toString()}
//           } else {
//             return const SizedBox();
//           }
//         },
